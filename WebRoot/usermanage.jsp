  ...
  <!--<![endif]-->
    ...
    <div class="navbar" >
        <div class="navbar-inner" >
                ...
                <a class="brand" href="users.html"></span><span class="first">I-java <span class="second">Admin</span></a>
        </div>
    </div>
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            <li><a href="firstpage.jsp" target="_blank" >主页</a></li>
...
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-plus"></i>新建用户</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
  	...
  	%>
        <tr>
          ...
          <td><%=user.getRank() %></td>
          <td>
              <a href="UserServlet?type=changerank&&username=<%=user.getUsername() %>"><i class="icon-pencil"></i></a>
              <a href="UserServlet?type=deleteuser&&username=<%=user.getUsername() %>" ><i class="icon-remove"></i></a>
          </td>
        </tr>
      <%} %>
