	...
	<body>
		...
		<div class="reg">
			...
			<form action="" name="form" method="post">
				<div class="row">
					<label for="username">用户名:</label><input type="text" name="username" id="username" placeholder="请输入用户名" class="input"/>
				</div>
				<div class="row">
					<label for="username">密 码:</label><input type="password" name="password" id="password" placeholder="请输入密码" class="input"/>
				</div>
				
				
				<a href="javascript:tosubmit();" class="submit">登录</a>
			</form>
		</div>
