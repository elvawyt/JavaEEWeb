	...
	<body>
		...
		<div class="reg">
			...
			<form action="" name= form method="post">
				<div class="row">
					<label for="username">问题标题:</label><input type="text" name="qtitle" id="qtitle" placeholder="请输入问题标题" class="input"/>
				</div>
				
				<div class="row">
				<label for="username">问题内容:</label><textarea name="qcontent" rows="40" cols="40" class="text"></textarea>
				</div>
				<div class="row">

					<label for="username">类型:</label>
					<input type="radio" name="qtype" value="java"/>java
					<input type="radio" name="qtype" value="ht" />HTML
					<input type="radio" name="qtype" value="jsp"/>JSP					
					<input type="radio" name="qtype" value="db"/>Database
