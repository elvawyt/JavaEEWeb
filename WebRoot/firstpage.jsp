...
<html lang="zh-CN">
  <head>
   ...
   <jsp:include page="/FirstPageServlet"></jsp:include> 
  <body>
  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="firstpage.jsp">iJava 资源分享平台</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li ><a href="#" target="_self">资源</a></li>
    ...
    <form class="navbar-form navbar-left">
      ...
      <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="pass.jsp" target="_blank">注册</a></li>
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p>...</p>
        <p><a href="#" class="btn btn-primary" role="button">查看更多</a></p>
      </div>
    </div>
  </div>
