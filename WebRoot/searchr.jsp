    ...
    <table class="table">
      ...
      <tbody>
  		...
  		for(int i=0;i<list1.size();i++){
  			ResourceVo resource=(ResourceVo)list1.get(i);
  	%>
  	 <td>#<%=i+1 %></td>
  	<td><%=resource.getSourcename()%></td>
   	<td><%=resource.getDlnumber() %></td>
    <td><%=resource.getPermission()%></td>
    <td><%=resource.getName()%></td>
   	<td>
  
          	  <a href="ResourceServlet?type=changepermission&&sourcename=<%=resource.getSourcename()%>"><i class="icon-arrow-up"></i></a>
              <a href="ResourceServlet?type=agreeupload&&sourcename=<%=resource.getSourcename()%>"><i class="icon-ok"></i></a>
